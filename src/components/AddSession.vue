        ...
        <div class="col-12">
            <form novalidate @submit.prevent="addSession">
                <div class="form-group row">
                    <label htmlFor="sequenceId" class="col-sm-3 col-form-label">Sequence ID</label>
                    <div class="col-sm-9">
                        <input 
                            class="form-control"
                            type="text"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="name" id="name" placeholder=""  aria-describedby="NameHelpId" v-model="sessionDetails.name" />
                        <small id="NameHelpId" class="text-muted">The title of the session</small>
                    </div>
                </div>
                <div class="form-group row">
                    <label htmlFor="speaker" class="col-sm-3 col-form-label">Speaker(s)</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="speaker" id="speaker" placeholder="" aria-describedby="speakerHelpId" v-model="sessionDetails.speaker" />
                ...
                <div class="form-group row">
                    <label htmlFor="duration" class="col-sm-3 col-form-label">Duration</label>
                    <div class="col-sm-9">
                        <input type="number" class="form-control" name="duration" id="duration" placeholder="" aria-describedby="durationHelpId" v-model.number="sessionDetails.duration" />
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <select class="form-control" name="level" id="level" v-model="sessionDetails.level">
                ...
                <div class="form-group row">
                    <label htmlFor="duration" class="col-sm-3 col-form-label">Abstract</label>
                    <div class="col-sm-9">
                        <textarea type="number" class="form-control" name="abstract" id="abstract" aria-describedby="abstractHelpId" v-model="sessionDetails.abstract"></textarea>
